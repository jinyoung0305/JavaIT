...
public class Review1 {
	public static void main(String[] args) {
		...
		// 자료형 : int, double, String, boolean 등, 개발자의 실수를 방지, 개발자의 의도를 명확화 
		String str;		// 변수 선언
		int num = 0; 	// 변수 초기화
		str = "";		// 값 대입
		boolean bool;
		...
		str = sc.nextLine();	// 띄어쓰기도 가능, 버그 떄문에 위에것들이랑 동시사용불가
		num = Integer.parseInt(sc.nextLine()); 		// nextLine() 쓸경우 형변환해서 사용하는게 좋음
		...
		// 줄인말
		num++;		// 1 더하고 저장 ( 해당 라인이 끝나 +1)
		++num;		// 1 더하고 저장 (문장 실행전에 먼저 +1)
		num--;		// 1 빼고 저장
		--num;		// num = num - 1
